...
cursorPathX = [startX, (39,25), (44,28), (45,37), (48,40), (48,28), (49,25)]
cursorPath2 = [start2, (55,6), (56,10), (53,14), (53,17), (56,17)]
cursorPathM = [startM, (2,32), (6,28), (9,34), (15,27), (18,40)]

cursorPath = cursorPathM
start = startM
testImg = cv2.imread(pathM)
result = np.zeros(testImg.shape, testImg.dtype)
testImg = cv2.cvtColor(testImg,cv.CV_RGB2GRAY)
# testImg = cv2.threshold(testImg, pixelThreshold, 255, cv2.THRESH_BINARY)[1]
BFSqueue = []
BFSexploredPixels = []
BFSexploredPixelLevels = []

# add first neighbors to the BFS queue
addNB(testImg, start, BFSqueue, 1)
...
cv2.circle(result, (int(start[0]*imgScaling + imgScaling * 1.5), int(start[1]*imgScaling + imgScaling * 0.5)), 5, (0,255,0), 3)

centersOfMass = []
group = 0
cmClusters = [[[start[0], start[1], 0, group]]]
